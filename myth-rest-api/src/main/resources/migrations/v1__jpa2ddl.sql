...
alter table music_characters
    add constraint UK_emovbn3k4pb5gs47sgevsnjdc unique (mythCharacters_id);
...
alter table paintings_characters
    add constraint UK_g6tyk1gj5jpft471avbs0vr6u unique (mythCharacters_id);

alter table paintings_images
    add constraint UK_h5gl73krlnk8fkl4xg77520vl unique (images_id);

alter table poems_characters
    add constraint UK_k9q9i5qkf5if9l46n2ibjda2t unique (mythCharacters_id);

alter table statues_characters
    add constraint UK_qnkn724gwr8dxuq4oxdflevny unique (mythCharacters_id);
...
alter table music_characters
    add constraint FKb6wsw84hakuvt82mfvq68h4mw
        foreign key (mythCharacters_id)
            references characters (id);
...
alter table paintings_characters
    add constraint FKjun60cta7c0ty8iggeiuc1u94
        foreign key (mythCharacters_id)
            references characters (id);
...
alter table poems_characters
    add constraint FKpgq2vep7aigvhj09eexi4ksbe
        foreign key (mythCharacters_id)
            references characters (id);
...
alter table statues_characters
    add constraint FKob77pt5mvtu5er97qlluxw8ym
        foreign key (mythCharacters_id)
            references characters (id);
